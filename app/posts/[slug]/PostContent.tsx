          ...
          <div className="max-w-4xl mx-auto px-6 md:px-12 py-4">
            <div className="flex items-center gap-3 text-sm">
              ...
              <p className="text-charcoal">
                <strong className="text-burgundy">Note:</strong> All articles are written by one person in Persian. As manual translation takes time, some translations may be AI-assisted — <Link href={`/posts/${slug}`} className="underline text-burgundy hover:text-burgundy/70 transition-colors font-medium">read the original</Link>.
              </p>
            </div>
          </div>
        </div>
